  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="goodsPurchaseInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="purchaseId" />
        <el-table-column label="商品编号" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="goodsId" />
        <el-table-column label="进货标题" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="purchaseTitle" />
        <el-table-column label="进货数量" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="quantity" />
...
<script>
import { listGoodsPurchaseInfo, getGoodsPurchaseInfo, delGoodsPurchaseInfo, addGoodsPurchaseInfo, updateGoodsPurchaseInfo } from "@/api/manage/goodsPurchaseInfo";
