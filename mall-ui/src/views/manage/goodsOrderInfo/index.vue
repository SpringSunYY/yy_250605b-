  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="goodsOrderInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="orderId" />
        ...
        <el-table-column label="支付金额" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="totalAmount" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="支付金额" prop="totalAmount">
          <el-input v-model="form.totalAmount" placeholder="请输入支付金额" />
        </el-form-item>
...
<script>
import { listGoodsOrderInfo, getGoodsOrderInfo, delGoodsOrderInfo, addGoodsOrderInfo, updateGoodsOrderInfo } from "@/api/manage/goodsOrderInfo";
