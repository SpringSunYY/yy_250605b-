<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="分类名称" align="center" :show-overflow-tooltip="true" v-if="columns[1].visible"
                       prop="categoryName"
      />
      <el-table-column label="创建人" align="center" :show-overflow-tooltip="true" v-if="columns[2].visible"
                       prop="createBy"
      />
      ...
      <el-table-column label="更新人" align="center" :show-overflow-tooltip="true" v-if="columns[4].visible"
                       prop="updateBy"
      />
      ...
      <el-table-column label="备注" align="center" :show-overflow-tooltip="true" v-if="columns[6].visible"
                       prop="remark"
      />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="父级编号" prop="parentId">
          <treeselect v-model="form.parentId" :options="goodsCategoryInfoOptions" :normalizer="normalizer"
                      placeholder="请选择父级编号"
          />
        </el-form-item>
        <el-form-item label="分类名称" prop="categoryName">
...
<script>
import {
  listGoodsCategoryInfo,
  getGoodsCategoryInfo,
  delGoodsCategoryInfo,
  addGoodsCategoryInfo,
  updateGoodsCategoryInfo
} from '@/api/manage/goodsCategoryInfo'
